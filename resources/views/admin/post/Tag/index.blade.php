                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->created_at ->diffForHumans() }}</td>
                                            ...
                                            <td>
                                                <div class="status-toggle">
                                                    <input type="checkbox" status_id={{ $data->id }} {{ $data-> status == true ? 'checked="checked"':'' }} id="tag_status_{{$loop->index+1 }}" class="check">
                                        ...
                                        <td>
                                            ...
                                            <a href="#" edit_id="{{ $data->id }}" class="btn btn-sm btn-warning update_tag" data-toggle="tooltip modal" title="Edit"><i class="fa fa-telegram" aria-hidden="true"></i></a>
                                            <form action="{{ route('post-tag.destroy', $data->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('post-tag.store') }}" method="POST"  class="form-group">
                    @csrf
...
<div class="modal fade" id="edit_tag_modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('post-tag.update',1) }}" method="POST"  class="form-group">
                    @csrf
                    @method('PUT')
